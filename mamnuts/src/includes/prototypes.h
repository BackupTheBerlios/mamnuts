...
/*
  functions in tmore.c 
*/
/* tmore is still buggy and won't even compile under some circumstances. Use at your own risk! */
/*
void visual(UR_OBJECT,int); 
BU_OBJ create_buf() ;
int V_more(BU_OBJ ,int );
int find_pag(BU_OBJ );
void envia_pagina(BU_OBJ);
void debufferiza();
BU_OBJ find_buffer(int );
void bufferiza(BU_OBJ ,const char * , int );
void despeja_buffer(BU_OBJ );
void poem_barra(int );
void  inicia_visual(UR_OBJECT);
*/
